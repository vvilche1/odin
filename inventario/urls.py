...
from .views import index, update_inventario, generar_pdf, create_libros, create_cd, create_resp, create_inventario, create_issue,libro_edit, issue_edit, resp_edit, cd_edit, inventario_edit
